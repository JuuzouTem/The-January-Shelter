...
- [ ] **Phase 1: Setup & Atmosphere**
  ...
  - [ ] Game Context oluşturuldu.
  - [ ] SnowFall bileşeni eklendi.

- [ ] **Phase 2: The Treehouse (Interactive Room)**
  - [ ] **RoomScene Container:** Odanın genel yerleşimi ve arka planı (CSS Art).
  - [ ] **InteractiveItem:** Ortak etkileşim bileşeni.
  - [ ] **Çay/Ayran:** Tıkladıkça opacity/doluluk oranı azalan bardak bileşeni.
  - [ ] **Bitki (Easter Egg):** Glitch efekti ve "BİTKİ PORNOSU!" yazısı.
  - [ ] **Radyo:** Winamp benzeri mini player (`howler.js` entegrasyonu).
  - [ ] **Baykuş:** Tıklayınca göz kırpıp "Hoot hoot" diyen ve baloncuk çıkaran animasyon.
  - [ ] **Kitaplık:** Rastgele alıntı sistemi (`data/quotes.ts`).
